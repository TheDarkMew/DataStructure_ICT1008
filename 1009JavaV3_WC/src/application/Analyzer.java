...
public class Analyzer {
	...
	public void initWordCloud() throws IOException {
    	...
    	resultWords = WordCloudAnalyzer.mostFrequentWords("stopwords.txt", 435);
         ...
         final List<WordFrequency> wordFrequencies = frequencyAnalyzer.load(resultWords);
         final Dimension dimension = new Dimension(600, 600);
         final WordCloud wordCloud = new WordCloud(dimension, CollisionMode.PIXEL_PERFECT);
         wordCloud.setPadding(2);
         wordCloud.setKumoFont(new KumoFont("Simple Slumg__G", FontWeight.BOLD));
         wordCloud.setBackground(new PixelBoundryBackground("backgrounds/earth.bmp"));
         //wordCloud.setBackground(new PixelBoundryBackground(getInputStream("backgrounds/cloud_fg.bmp")));
         //wordCloud.setBackground(new PixelBoundryBackground(getInputStream("backgrounds/haskell_.bmp")));
         ...
         wordCloud.writeToFile("output/KobeWordCloud.png");
